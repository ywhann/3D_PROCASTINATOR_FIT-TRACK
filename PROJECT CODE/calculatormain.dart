	...
	body: SingleChildScrollView(
		...
		child: Container(
			...
			child: Column(
				...
				Text("Fit Track",style: TextStyle(fontWeight: FontWeight.bold,color: Color(0xFF0038FF),fontSize: 25),),
				SizedBox(
					height: 30,
				),
				...
				Padding(
					...
					child: SizedBox(
						...
						child: Text("Compute",style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold,color: Colors.white),),
						style: ButtonStyle(
				...
				Center(child: Row(
					...
					Column(
						...
						Text("Malnourished",style: TextStyle(fontSize: 15),)
						],
					),
					Column(
						mainAxisAlignment: MainAxisAlignment.center,
						...
						Text("Healthy",style: TextStyle(fontSize: 15),)
						],
					),
					Column(
						mainAxisAlignment: MainAxisAlignment.center,
